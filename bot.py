...
@bot.command(name='start')#Botu baslatmak icin bu komutu kullanirsiniz
...
@bot.command(name='info')#Kullanila bilecek komutlari bu komut ile goruntuluge bilirsiniz
async def info(ctx):
    await ctx.send("""
...
@bot.command(name='new_project') #Bu komutla yeni bir proje eklersiniz
...
@bot.command(name='projects') #Bu komut ile kayd etdiginiz tum projeleri goruntuleye bilirsiniz
...
@bot.command(name='skills') #Bu kumutla belirli bir projeye beceri eklersiniz
...
@bot.command(name='delete')#Bu komutla belirli bir projeyi silersiniz
...
@bot.command(name='update_projects')#Bu komutla belirli bir projedeki bilgileri guncelleye bilirsiniz
